...
@NoArgsConstructor
@AllArgsConstructor
public class SnoozeDoseRequest {
    ...
    @NotNull(message = "El campo minutes es requerido.")
    @Min(value = 1, message = "Los minutos deben ser al menos 1.")
    @Max(value = 240, message = "Los minutos no pueden exceder 240.")
